                                ...
                                <div class="product-details-des">
                                    ...
                                    <div class="ratings d-flex">
                                        <div class="pro-review">
                                            <?php $tongBinhLuan = count($listBinhLuan);   ?>
                            ...
                            <div class="col-lg-12">
                                <div class="product-review-info">
                                    <ul class="nav review-tab">
                                        ...
                                        <li>
                                            <a class="active" data-bs-toggle="tab" href="#tab_three">Bình luận <?= $tongBinhLuan ?></a>
                                        </li>
                                    </ul>
                                    <div class="tab-content reviews-tab">

                                        <div class="tab-content reviews-tab" id="tab_three">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="section-title text-center">
                        ...
                        <p class="sub-title">Thêm sản phẩm danh liên quan vào danh sách hàng tuần</p>
                    </div>
                    <!-- section title start -->
                </div>
            </div>
