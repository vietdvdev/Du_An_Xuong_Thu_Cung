    ...
    public function getAllSanPham(){
        ...
        try {
            $sql = "INSERT INTO san_phams
             (ten_san_pham,gia_san_pham,gia_khuyen_mai, so_luong,ngay_nhap,danh_muc_id, trang_thai,mo_ta,hinh_anh) values
        ...
        try {
            $sql = "INSERT INTO hinh_anh_san_phams
             (san_pham_id,link_hinh_anh) values
             (:san_pham_id,:link_hinh_anh)";
            $stmt = $this->conn->prepare($sql);
            $stmt->execute([
