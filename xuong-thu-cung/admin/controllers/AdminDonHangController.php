...
class AdminDonHangController {
    ...
    public function detailDonHang(){
        ...
        // lấy danh sách sản phẩm của đơn hàng ở bảng chi chi_tiet_don_hangs
      ...
      public function postEditDonHang(){
       ...
       if($_SERVER['REQUEST_METHOD']== 'POST'){
            ...
            if(empty($ten_nguoi_nhan)){
             $errors['ten_nguoi_nhan'] = 'Tên người nhận không được để chống';
            }
  
            if(empty($email_nguoi_nhan)){
             $errors['email_nguoi_nhan'] = 'Email người nhận không được để chống';
            }

            if(empty($sdt_nguoi_nhan)){
             $errors['sdt_nguoi_nhan'] = 'SDT người nhận không được để chống';
            }

            if(empty($dia_chi_nguoi_nhan)){
             $errors['dia_chi_nguoi_nhan'] = ' Địa chỉ người nhận không được để chống';
            }

      
            if(empty($trang_thai_id)){
             $errors['trang_thai_id'] = ' Phải chọn trạng thái  ';
            }
    ...
    //          $errors['gia_khuyen_mai'] = 'Giá khuyến mại sản phẩm không được để chống';
    //         }
