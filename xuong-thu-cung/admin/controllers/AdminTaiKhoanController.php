...
//             if(empty($dia_chi)){
//              $errors['dia_chi'] = 'Vui lòng chọn trạng thái';
//             }
...
//     if (!empty($old_avatar)) {
//         deleteFile($old_avatar); // Xóa ảnh cũ nếu có
//     }
// } else {
//     $new_avatar = $old_avatar; // Không upload thì giữ lại ảnh cũ
// }


//            $this->modelTaiKhoan->updateTaiKhoanCaNhanQuanTri( $quan_tri_id,
//                                                 $ho_ten,
//                                                 $email,
//                                                 $so_dien_thoai,
//                                                 $gioi_tinh,
