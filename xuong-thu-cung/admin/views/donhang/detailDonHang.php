        ...
        <div class="col-sm-2">
            <form action="" method="post" class="form-group">
                <select name="" id="">
                    ...
                    <option
                     <?=  $trangThai['id'] == $donHang['trang_thai_id'] ? 'selectd' : ''   ?>
          ...
          <div class="col-12">
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row">
                <div class="col-12">
                  <h4>
                   <i class="nav-icon fas fa-cat"></i>Shop thú cưng Vietdv
              ...
              <div class="row invoice-info">
                ...
                <div class="col-sm-4 invoice-col">
                  ...
                  <address>
                   ...
                   <b>Email người nhận:</b> <?= $donHang['email_nguoi_nhan'] ?> <br>
                   <b>Số điện thoại người nhận:</b> <?= $donHang['sdt_nguoi_nhan'] ?><br>
                   <b>Địa chỉ người nhận:</b> <?= $donHang['dia_chi_nguoi_nhan'] ?><br>
                  </address>
                </div>
                <!-- /.col -->
                <div class="col-sm-4 invoice-col">
                  ...
                  <address>
                   ...
                   <b>Ghi chú đơn hàng:</b>  <?= $donHang['ghi_chu'] ?><br>
              ...
              <div class="row">
                ...
                <!-- /.col -->
                <div class="col-6">
                  <p class="lead">Ngày đặt hàng: <?php $donHang['ngay_dat']  ?></p>
