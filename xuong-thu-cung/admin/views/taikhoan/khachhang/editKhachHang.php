              ...
              <form action="<?= BASE_URL_ADMIN . '?act=sua-khach-hang'?>" method="POST">
                ...
                <div class="card-body">
                  <div class="form-group ">
                    <label >Họ tên </label>
                    <input type="text" class="form-control" name="ho_ten" value="<?= $khachHang['ho_ten'] ?>"  placeholder="Nhập tên họ tên">
                  ...
                  <div class="form-group ">
                    ...
                    <?php  if (isset($_SESSION['error']['ngay_sinh'])){ ?>
                        <p class="text-danger"><?= $_SESSION['errongay_sinhr']['ngay_sinh'] ?></p>
                   <?php } ?>
                  </div>                   
